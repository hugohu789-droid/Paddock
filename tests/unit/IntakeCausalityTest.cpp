...
Mob ewes(int head, double liveweight_kg = 60.0) {
  ...
  mob.animal.appetite_lactation_peak_days = 28.0;
  mob.animal.appetite_lactation_curve_exponent = 1.4;
  mob.animal.appetite_lactation_peak_no_young = 0.524;
  mob.animal.appetite_lactation_peak_one_young = 0.524;
  mob.animal.appetite_lactation_peak_two_young = 0.707;
  mob.animal.appetite_lactation_peak_three_young = 0.891;
