...
| 12 | Whether Nicol and Brookes' published ewe maintenance includes MEgraze and Ecold, which this model's maintenance figure does not | M3 | Nicol and Brookes (2007), *Pasture and supplements for grazing animals*, NZSAP Occasional Publication No. 14 - **listed on nzsap.org**, so obtainable | **access route resolved.** NZSAP sells *Pasture and Supplements for Grazing Animals*; the chapter is number 10, pp. 151-172. The model is 1.9% low at 45 kg and 14.8% at 60 kg, and the review quotes their equation as carrying both terms. One thing not to resolve by assumption: the literature cites this chapter as **2007** and NZSAP's current catalogue lists the volume as Occasional Publication No. 14 (**2017**). Record both until the title page settles it, rather than picking one |
