...
| E20 | **A dry year cannot reach the stock, and the arithmetic says why in two sourced halves.** The farm grows about 1.6 times what a Canterbury dryland farm grows, and its ewes eat about a third of what a ewe eats; multiplied, it carries roughly five times the feed it needs, so no drought can pinch it. **The grass.** Measured water use efficiency over three years is 20.2, 19.5 and 20.2 kg DM/ha/mm - Martin et al. (2006) put irrigated ryegrass/white clover at 20 and Canterbury dryland at 12.3, so the model converts water to dry matter at an irrigated rate on a rain-fed farm, and the tell is that the figure does not move between a 527 mm year and a 1,036 mm one when a real one would. Annual growth is 9.5 to 14.3 t DM/ha where Winchmore's dryland treatment implies 5.5 to 6.5. **The stock.** A ewe here eats 192 kg DM a year, 0.52 kg a day; the New Zealand stock unit is a 55 kg ewe weaning a 25 kg lamb on 550 kg DM a year, 1.51 kg a day. The gap is not a defect to hunt: `AnimalEnergy` charges maintenance and gain and has no conceptus or lactation term, and lactation is the deferred step 4. Utilisation lands at 6 to 9% where a New Zealand sheep farm runs 65 to 80%. **So M4's drought acceptance waits on step 4 and on a pasture calibration, not on the decision rules**, which were the first thing suspected and are not at fault | M4 |
...
| E22 | **Lambs do not graze.** `keep_the_books` now sets the grazing mob from the flock's breeding head, so what the farmer sells stops eating - but the lamb crop is left out, because the mob carries one representative animal at a ewe's liveweight and counting 529 lambs there would feed them as 529 grown ewes, inventing intake the same way drafting on an undriven liveweight invented income. Real lambs eat from soon after birth. The fix is grazing per cohort rather than per mob, which is also what step 4 needs | M4 |
