...
| E20 | **REOPENED, because the pass was an artifact.** M4's drought acceptance did pass: the driest of ten years took cover below the 1,600 kg DM/ha the farmer holds the farm to, the mob went short, and the farmer sold. **Half of that cover was thatch.** The threshold was being crossed by a number inflated with dead standing material (E26), and once the dead pool was corrected and senescence given a season (E27) an honest cover does not fall to 1,600 at 5.2 ewes a hectare even in the driest year in ten. The drought is still there and still measurable - several hundred kilograms less standing through January and February - but it does not force a sale, and **the two years now harvest within 2.5% of each other because neither is feed-limited**: intake is set by what the stock need, not by what the paddock offers. That is the understocking, which is what E20 always was; the destocking was covering for it. Utilisation 21%. `DroughtDestockingTest` asserts the summer difference and records the absent sale rather than asserting it away | M4 |
