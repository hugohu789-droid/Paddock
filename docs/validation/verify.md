...
| E38 | **A wet year's low utilisation is a missing feature, not a fault.** Intake is now almost flat across the decade - 2,437, 2,432 and 2,425 kg DM/ha in the driest, an ordinary and the wettest year - because the stock eat what they need and the pasture grows what the weather allows: 5.3, 7.0 and 9.4 t. So utilisation reads 46%, 35% and 26% for the same farm doing the same thing. **A real Canterbury farm cuts the spring surplus for silage or hay and feeds it back in a dry summer or a cold winter**, which is exactly the mechanism that turns a good year's growth into a bad year's feed, and this model has none: it can buy feed and it cannot make any. Until it can, the wet-year figure is describing a farm with no way to store a surplus rather than one that wastes it. Feed conservation is the next feature this argues for, and it is M5's feed budgeting | M5 |
