...
| E20 | **A dry year still does not quite reach the stock, and one of the two reasons is now closed.** The farm used to carry about five times the feed it needed, in two sourced halves. **The stock half is fixed**: pregnancy and lactation are implemented from OVERSEER's Eq. 26 and 35, so a ewe now eats 351 kg DM a year against 192 before, utilisation is 20% rather than 9%, and the driest year's lowest cover falls to 1,605 kg DM/ha against the farmer's 1,600 floor - five kilograms from triggering. The remaining gap to the stock unit's 550 kg is largely E22, the lamb that does not graze. **The grass half is open**: water use efficiency still measures near 20 kg DM/ha/mm, which Martin et al. (2006) give for *irrigated* ryegrass and clover against 12.3 for Canterbury dryland, and it does not move between a 527 mm year and a 1,036 mm one, which is the tell. Annual growth is 8.8 to 13.5 t DM/ha where Winchmore's dryland treatment implies 5.5 to 6.5. **So M4's drought acceptance now waits on the pasture calibration alone**, and the decision rules were never at fault | M4 |
