...
| E15 | **Rain is monotonically favourable, and it should not be.** The sporulation test asks for 4 mm over 48 hours and treats anything wetter as at least as good. Marbrook (1962) found sporidesmin is rapidly eluted from spores by water, so heavy rain washes toxin off pasture that a drizzle would have left on it. The model therefore reads a downpour as a worse day than a drizzle when the literature says the opposite. No elution rate against rainfall has been located | M4 |
| E16 | **Sunlight destroys the toxin and the model does not know.** The same 1962 paper reports that aqueous sporidesmin exposed to bright sunlight becomes non-toxic or much less so. Every scenario here carries daily solar radiation and none of it reaches the toxin. Wiring it needs a photolysis rate | M4 |
