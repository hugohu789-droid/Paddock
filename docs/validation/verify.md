...
| E20 | **The drought now reaches the farmer's floor and stops one step short of the stock, and only the grass is still slack.** The farm used to carry about five times the feed it needed, in two sourced halves. **The stock half is closed.** Pregnancy and lactation are charged (E20's first fix) and the lamb crop grazes (E22), so intake per ewe went 192 to 351 kg DM a year against the stock unit's 550, utilisation went 9% to 20%, and the driest year in ten now takes cover to 1,597 kg DM/ha against the 1,600 the farmer holds it to - the first time a dry year has reached a management threshold at all. No mob is short even so, because cover is a farm mean and a mean below target still leaves feed where the mobs are. **The grass half is open.** Water use efficiency measures near 20 kg DM/ha/mm, which Martin et al. (2006) give for *irrigated* ryegrass and clover against 12.3 for Canterbury dryland, and it does not move between a 527 mm year and a 1,036 mm one, which is the tell. Annual growth is 8.8 to 13.5 t DM/ha where Winchmore's dryland treatment implies 5.5 to 6.5. **So M4's drought acceptance waits on E21, the pasture calibration, and on nothing else** | M4 |
